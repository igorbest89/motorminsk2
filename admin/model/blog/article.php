...
class ModelBlogArticle extends Model {
    ...
    public function addArticle($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "easy_blog_article SET sort_order = '" . (int)$data['sort_order'] . "', image = '" . $this->db->escape($data['image']) . "', status = '" . (int)$data['status'] . "', date_modified = NOW()");
	...
	public function editArticle($article_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "easy_blog_article SET sort_order = '" . (int)$data['sort_order'] . "', image = '" . $this->db->escape($data['image']) . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE article_id = '" . (int)$article_id . "'");

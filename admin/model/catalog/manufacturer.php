...
class ModelCatalogManufacturer extends Model {
	...
	public function addAliasForManufacturer($data)
    {
        if ($data['keyword']) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'manufacturer_id=" . (int)$data['manufacturer_id'] . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
        }
    }

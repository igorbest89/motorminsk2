...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_image_2'] = $this->language->get('entry_image_2');
...
//		die();
        ...
        } elseif (!empty($manufacturer_info) && is_file(DIR_IMAGE . $manufacturer_info['image2'])) {
            $data['thumb2'] = $this->model_tool_image->resize($manufacturer_info['image2'], 100, 100);
        } else {

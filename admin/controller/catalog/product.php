...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_recomend'] = $this->language->get('entry_recomend');
		...
		$data['help_recomend'] = $this->language->get('help_recomend');
        ...
        if (isset($this->request->post['product_recomend'])) {
            $products_recomend = $this->request->post['product_recomend'];
        } elseif (isset($this->request->get['product_id'])) {
            $products_recomend = $this->model_catalog_product->getProductRecomend($this->request->get['product_id']);
        } else {
            $products_recomend = array();
        }

        $data['product_recomends'] = array();

        foreach ($products_recomend as $product_id) {
            $recomend_info = $this->model_catalog_product->getProduct($product_id);

            if ($recomend_info) {
                $data['product_recomends'][] = array(
                    'product_id' => $recomend_info['product_id'],
                    'name'       => $recomend_info['name']
                );
            }
        }

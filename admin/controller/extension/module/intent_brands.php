...
//            die();
            if (!isset($this->request->get['module_id'])) {
                ...
                $this->model_extension_module->addModule('intent_brands', $this->request->post);
            } else {
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/intent_brands', 'token=' . $this->session->data['token'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/intent_brands', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
        }
        ...
        $this->response->setOutput($this->load->view('extension/module/intent_brands', $data));
    }
...
//        die();
        ...
        if (!$this->user->hasPermission('modify', 'extension/module/intent_brands')) {
    ...
    public function ajaxHtmlHelper()
    {
        ...
        $this->response->setOutput($this->load->view('extension/module/intent_ajax_brands', $data));

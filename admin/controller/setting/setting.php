...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_unp'])) {
            $data['config_unp'] = $this->request->post['config_unp'];
        } else {
            $data['config_unp'] = $this->config->get('config_unp');
        }
        if (isset($this->request->post['config_okpo'])) {
            $data['config_okpo'] = $this->request->post['config_okpo'];
        } else {
            $data['config_okpo'] = $this->config->get('config_okpo');
        }

		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
            ...
            if ($this->user->hasPermission('access', 'news/news')) {
                $news[] = array(
                    'name'	   => $this->language->get('text_single_news'),
            ...
            if ($this->user->hasPermission('access', 'localisation/store_group')) {
                $localisation[] = array(
                    'name'	   => $this->language->get('text_form_group'),
                    'href'     => $this->url->link('localisation/store_group', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

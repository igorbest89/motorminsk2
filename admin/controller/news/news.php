...
class ControllerNewsNews extends Controller {
    ...
    public function copy() {
        ...
        if (isset($this->request->post['selected']) && $this->validateCopy()) {
            foreach ($this->request->post['selected'] as $news_id) {
                $this->model_news_news->copyArticle($news_id);
            }
    ...
    protected function getList() {
        ...
        $data['setting'] = $this->url->link('news/setting', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $results = $this->model_news_news->getNews($filter_data);
    ...
    protected function getForm() {
        ...
        if (isset($this->request->get['news_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $article_info = $this->model_news_news->getNewsSingle($this->request->get['news_id']);
        }

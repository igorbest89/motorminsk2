                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="news_description[<?php echo $language['language_id']; ?>][intro_text]" placeholder="<?php echo $entry_intro_text; ?>" id="input-intro-text<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['intro_text'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group required">

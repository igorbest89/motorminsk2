        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-unp">УНП</label>
                <div class="col-sm-10">
                  <input type="text" name="config_unp" value="<?php echo $config_unp; ?>" placeholder="УНП" id="input-unp" class="form-control" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-okpo">ОКПО</label>
                <div class="col-sm-10">
                  <input type="text" name="config_okpo" value="<?php echo $config_okpo; ?>" placeholder="ОКПО" id="input-okpo" class="form-control" />
                </div>
              </div>

        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-properties<?php echo $language['language_id']; ?>"><?php echo $entry_properties; ?></label>
                    <div class="col-sm-10">
                      <textarea name="category_description[<?php echo $language['language_id']; ?>][properties]" placeholder="<?php echo $entry_properties; ?>" id="input-properties<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['properties'] : ''; ?></textarea>
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-process-status"><span data-toggle="tooltip" title="">Аттрибуты</span></label>
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($attributes as $attribute) { ?>
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($attribute['id'], $category_attributes)) { ?>
                        <input type="checkbox" name="attribute[]" value="<?php echo $attribute['id']; ?>" checked="checked" />
                        <?php echo $attribute['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="attribute[]" value="<?php echo $attribute['id']; ?>" />
                        <?php echo $attribute['name']; ?>
                        <?php } ?>
                      </label>
                    </div>

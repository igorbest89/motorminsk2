            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'sort_order') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'count') { ?>
                    <a href="<?php echo $sort_count; ?>" class="<?php echo strtolower($order); ?>">Аттрибуты</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_count; ?>">Аттрибуты</a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $category['count']; ?></td>

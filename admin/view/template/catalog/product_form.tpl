        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-recomend"><span data-toggle="tooltip" title="<?php echo $help_recomend; ?>"><?php echo $entry_recomend; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="recomend" value="" placeholder="<?php echo $entry_recomend; ?>" id="input-recomend" class="form-control" />
                  <div id="product-recomend" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_recomends as $product_recomend) { ?>
                    <div id="product-recomend<?php echo $product_recomend['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_recomend['name']; ?>
                      <input type="hidden" name="product_recomend[]" value="<?php echo $product_recomend['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
...
// Recomend
$('input[name=\'recomend\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
  ...
  'select': function(item) {
    $('input[name=\'recomend\']').val('');

    $('#product-recomend' + item['value']).remove();

    $('#product-recomend').append('<div id="product-recomend' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_recomend[]"value="' + item['value'] + '" /></div>');
      }
});
...
$('#product-recomend').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});

                ...
                <?php foreach ($payment_methods as $payment_method) { ?>
                    <div class="radio">
                        <label for="<?php echo $payment_method['code']; ?>">
                            ...
                            <span class="simple-label-text"><?php echo $payment_method['title']; ?></span>
...
<script type="text/javascript"><!--
        ...
        $('#simplecheckout_payment .radio input:checked').parent().addClass('active');
        $(document).delegate('.row-shipping_field30 .radio input', 'change', function(){

        $('#simplecheckout_payment .radio input').parent().removeClass('active');

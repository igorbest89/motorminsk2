    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="form-wrap">
                    <h2>Регистрация</h2>
                    <h1><?php echo $oa_heading_title; ?></h1>
                    <br>
                </div>
                ...
                <div class="row">
                    <div id="content" class="col-sm-12">
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="oa_redirect" value="<?php echo $oa_redirect ?>"/>
                            <fieldset id="account">
                                <legend>Пожалуйста, уделите минуту, чтобы проверить и / или заполнить информацию о вашей учетной записи ниже.</legend>
                                <br>
                                ...
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label"
                                           for="input-lastname"><?php echo $entry_lastname; ?></label>
                                    <div class="col-sm-10">
                              ...
                              <div class="form-group">
                                ...
                                <div class="buttons">
                                    <div class="pull-right">
                                        <br>
                                        <input type="submit" value="Подттвердить"

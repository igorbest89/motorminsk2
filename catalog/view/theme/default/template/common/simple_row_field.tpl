<div class="form-group <?php if ($required) { ?>required<?php } ?> row-<?php echo $id ?>">
    <label class="control-label <?php echo $page == 'checkout' ? 'col-sm-12 simple-label' : 'col-sm-2' ?>" for="<?php echo $id ?>"><?php echo $label ?></label>
    <div class="<?php echo $page == 'checkout' ? 'col-sm-12 unset-padding' : 'col-sm-10' ?>">

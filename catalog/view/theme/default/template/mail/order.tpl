    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <?php if ($shipping_method) { ?>
            <b><?php echo $text_shipping_method; ?></b> <?php echo $shipping_method; ?><br />
              <?php if ($shipping_delivery == 1) { ?>
                <b>Город</b> <?php echo $shipping_city; ?><br />
                <b>Почтовый индекс</b> <?php echo $shipping_postcode; ?><br />
                <b>Адрес</b> <?php echo $shipping_address_1; ?>
              <?php } else { ?>
                <b>Адрес склада ЗАО Чистый берег</b> <?php echo $shipping_address_2['address']; ?><br />
                <b>Когда:</b> <?php echo $shipping_address_2['date']; ?><br />
                <b>Во сколько:</b> <?php echo $shipping_address_2['time']; ?>
             <?php } ?>
          <?php } ?>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
          <b><?php echo $text_firstname; ?></b> <?php echo $firstname; ?><br />
          <b><?php echo $text_lastname; ?></b> <?php echo $lastname; ?><br />

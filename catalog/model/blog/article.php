...
class ModelBlogArticle extends Model {
	public function getArticle($article_id) {
        $query = $this->db->query("SELECT DISTINCT a.article_id, a.image, a.sort_order, a.status, a.date_modified, ad.language_id, ad.name, ad.description, ad.intro_text, ad.meta_title, ad.meta_description, ad.meta_keyword FROM " . DB_PREFIX . "easy_blog_article a LEFT JOIN " . DB_PREFIX . "easy_blog_article_description ad ON (a.article_id = ad.article_id) WHERE a.article_id = '" . (int)$article_id . "' AND ad.language_id = '" . (int)$this->config->get('config_language_id') . "' AND a.status = '1' ");
    ...
    public function getArticles($data = array()) {
        ...
        $sql = "SELECT a.article_id, a.image , a.date_modified" . " FROM " . DB_PREFIX . "easy_blog_article a";
    ...
    public function getArticlesYears() {
            ...
            $query = $this->db->query("SELECT DISTINCT year(date_modified) as year FROM " . DB_PREFIX . "easy_blog_article ");

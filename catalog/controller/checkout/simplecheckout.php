...
//        echo "</pre>";
        ...
        $last_id = $this->model_checkout_order->getLastId();
        $this->_templateData['last_id']        = $last_id['id']+1;
    ...
    private function order() {
        ...
        $customer_info['email'] = (isset($this->session->data['simple']['shipping_address']['field28'])) ? $this->session->data['simple']['shipping_address']['field28'] : '';
        $customer_info['telephone'] = (isset($this->session->data['simple']['shipping_address']['field29'])) ? $this->session->data['simple']['shipping_address']['field29'] : '';
        $customer_info['firstname'] = (isset($this->session->data['simple']['shipping_address']['firstname'])) ? $this->session->data['simple']['shipping_address']['firstname'] : '';
        $customer_info['lastname'] = (isset($this->session->data['simple']['shipping_address']['lastname'])) ? $this->session->data['simple']['shipping_address']['lastname'] : '';
        ...
        if ($this->cart->hasShipping()) {
            ...
            $shipping_address['address_1'] = (isset($this->session->data['simple']['shipping']['field22'])) ? $this->session->data['simple']['shipping']['field22'] : '';
            $shipping_address['city'] = (isset($this->session->data['simple']['shipping']['field20'])) ? $this->session->data['simple']['shipping']['field20'] : '';
            $shipping_address['postcode'] = (isset($this->session->data['simple']['shipping']['field21'])) ? $this->session->data['simple']['shipping']['field21'] : '';

            $shipping_address['address_2'] = [
                'address' => (isset($this->session->data['simple']['shipping']['field23'])) ? $this->session->data['simple']['shipping']['field23'] : '',
                'date' => (isset($this->session->data['simple']['shipping']['field24'])) ? $this->session->data['simple']['shipping']['field24'] : '',
                'time' => (isset($this->session->data['simple']['shipping']['field25'])) ? $this->session->data['simple']['shipping']['field25'] : '',
            ];
            ...
            $data['shipping_address_2']      = json_encode($shipping_address['address_2']);
            ...
            if (isset($this->session->data['shipping_method']['title'])) {
                if($this->session->data['shipping_method']['cost'] != 0){
                    if($this->session->data['shipping_method']['cost'] == $this->session->data['shipping_method']['cost_minsk']){
                        $text = "Доставка по Минску  (" . $this->session->data['shipping_method']['cost_minsk'] . " руб.)";
                    }else{
                        $text = "Доставка по Белоруссии (" . $this->session->data['shipping_method']['cost'] . " руб.)";
                    }

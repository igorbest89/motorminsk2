...
class ControllerCheckoutSuccess extends Controller {
	public function index() {
        ...
        $data['text_message'] = sprintf($this->language->get('text_customer_all'), (isset($data['order_id'])) ? $data['order_id'] : $this->model_checkout_order->getLastId()['id'], $this->url->link('common/home'));
        ...
        $data['order_id'] = (isset($data['order_id'])) ? $data['order_id'] : $this->model_checkout_order->getLastId()['id'];
